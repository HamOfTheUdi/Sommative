...
class EmployesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employe" do
    assert_difference("Employe.count") do
      post employes_url, params: { employe: { garage_id: @employe.garage_id, nom: @employe.nom, specialite: @employe.specialite } }
    end
  ...
  test "should update employe" do
    patch employe_url(@employe), params: { employe: { garage_id: @employe.garage_id, nom: @employe.nom, specialite: @employe.specialite } }
