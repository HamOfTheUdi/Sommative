...
class GaragesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create garage" do
    assert_difference("Garage.count") do
      post garages_url, params: { garage: { adresse: @garage.adresse, capacite: @garage.capacite, nom: @garage.nom } }
    end
  ...
  test "should update garage" do
    patch garage_url(@garage), params: { garage: { adresse: @garage.adresse, capacite: @garage.capacite, nom: @garage.nom } }
